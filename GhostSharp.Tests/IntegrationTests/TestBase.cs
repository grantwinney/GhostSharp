...
namespace GhostSharp.Tests.IntegrationTests
{
    public class TestBase
    {
        ...
        protected static string ValidApiKey = Environment.GetEnvironmentVariable("API_Key") ?? "api_key";
        ...
        private List<string> testValues = new List<string> { ValidApiKey, ValidPost1Id, ValidPost1Slug,
