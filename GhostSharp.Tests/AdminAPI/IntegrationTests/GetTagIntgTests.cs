...
namespace GhostSharp.Tests.AdminAPI.IntegrationTests
{
    ...
    public class GetTagIntgTests : TestBase
    {
        ...
        [Test]
        public void GetTagBySlug_ReturnsTag_EvenWhenTagAssociatedWithNoPublishedPosts()
        {
            var tag = auth.GetTagBySlug(ValidTagWithNoPublishedPostsSlug);

            Assert.IsNotNull(tag);
            Assert.AreEqual(ValidTagWithNoPublishedPostsSlug, tag.Slug);
            Assert.IsNull(tag.Count);
        }
